...
SPHERE_TARGETS: dict[int, tuple[int, int]] = {
    1:  (9, 12),   # Личность и тело — центральная сфера
    2:  (6,  8),   # Ресурсы и ценности
    3:  (7,  9),   # Мышление и коммуникации
    4:  (6,  8),   # Семья и корни
    5:  (6,  8),   # Творчество и самовыражение
    6:  (5,  7),   # Здоровье и служение
    7:  (8, 11),   # Отношения и партнёрство — ключевая сфера
    8:  (7, 10),   # Трансформация и глубина
    9:  (6,  8),   # Смысл и путешествия
    10: (7,  9),   # Карьера и репутация
    11: (5,  7),   # Социум и мечты
