...
SPHERE_TARGETS: dict[int, tuple[int, int]] = {
    1:  (12, 16),  # Личность и тело — центральная сфера
    2:  ( 9, 12),  # Ресурсы и ценности
    3:  (10, 13),  # Мышление и коммуникации
    4:  ( 9, 12),  # Семья и корни
    5:  ( 9, 12),  # Творчество и самовыражение
    6:  ( 8, 11),  # Здоровье и служение
    7:  (11, 15),  # Отношения и партнёрство — ключевая сфера
    8:  (10, 14),  # Трансформация и глубина
    9:  ( 9, 12),  # Смысл и путешествия
    10: (10, 13),  # Карьера и репутация
    11: ( 8, 11),  # Социум и мечты
    12: (11, 15),  # Тень и растворение — ключевая сфера
}
