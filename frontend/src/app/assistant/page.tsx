...
export default function AssistantPage() {
    ...
    return (
        ...
        >
            ...
            <div
                ref={scrollRef}
                style={{ flex: 1, overflowY: "auto", padding: "76px 16px 88px", display: "flex", flexDirection: "column", justifyContent: "flex-end", gap: 10, scrollbarWidth: "none", position: "relative", zIndex: 10 }}
